...
// TODO:
// - think about sensible size for any_event, it should be smaller to nest it
// into another basic_polymorphic for deferred events
// - basic_polymorphic_base must be copyable for this optimization, consider
// what this means

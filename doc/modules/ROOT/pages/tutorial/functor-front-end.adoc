...
== Customizing functor signatures

If you want to further customize your functor signature, you can do so with an adapter utilizing CRTP.
For demonstration purposes we create a new functor signature, which takes only the event as input argument.

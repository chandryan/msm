= Backmp11 back-end (C{plus}{plus}17)
...
*Change:* The API `process_event` will reject an event and return `discarded` when called during event processing instead of automatically enqueueing it.
